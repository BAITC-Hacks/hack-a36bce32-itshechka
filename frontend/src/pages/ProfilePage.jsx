    ...
    <div>
      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-[1.4fr_1fr]">
        <Card className="p-6 sm:p-8">
          <div className="flex items-center gap-4"><div className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-brand-50 text-brand-700"><UserRound size={26} /></div><div className="min-w-0"><h2 className="truncate text-xl font-bold text-slate-950">{user?.name}</h2><p className="truncate text-sm text-slate-500">{user?.email}</p></div></div>
