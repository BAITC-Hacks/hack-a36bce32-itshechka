    ...
    <Card className="p-5 shadow-sm sm:p-7">
      <form onSubmit={submit}>
        <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
          ...
          <Button onClick={insertExample} type="button" variant="secondary"><Sparkles size={17} />Вставить пример</Button>
        </div>
        ...
        <div className="mt-3 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <Button size="lg" type="submit">Создать материалы<ArrowRight size={18} /></Button>
        </div>
      </form>
    </Card>
  );
